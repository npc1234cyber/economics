...
- Be fast, efficient, accurate
- Look out for units, decimals, currency, %

4 marker:
- Explain in detail (2 marks)
- Use data effectively (2 marks)
- Think chains for 2 marks
- Data must back up your explanation for 2 marks
- Be fast and accurate (4 minutes)
...
- Draw diagram (in this case just explain how to draw the diagram)
...
15 Marker:
- I usually recommend three points (but you can also do two points if each point is more detailed). You can also start with a few key definitions.
...
• is well organised and develops a selection of the key issues that
are relevant to the question
• shows sound knowledge and understanding of economic
terminology, concepts and principles with few, if any, errors
• includes good application of relevant economic principles to the
given context and, where appropriate, good use of data to support
the response
...
25 Marker:
Exemplar Structure:
Extract F (lines 1–2) states that ‘Charities and think tanks have called for action to reduce job insecurity, lower housing costs and increase earnings for low-paid workers.’ Using the extracts and your knowledge of economics, evaluate policies that could be used to reduce in-work poverty in the UK. [25 marks] 

25 MARKER STRUCTURE:
Para 1: 
List some policies that could work, end with a sentence which sums up your answer e.g. Poverty can be defined in two ways: …….. Policies that could be used to reduce in-work poverty include….. In my overall judgement, the most effective policies to reduce in work poverty are…….. 

Para 2: explain how one economic policy option could work, ending with the pros and cons e.g. “One economic policy option to achieve the governments objective would be….. This policy can be shown in a diagram as follows:……… advantages of this policy option could be…… however drawbacks of this policy could be…….. 

Paragraph 3: explain how a second economic policy could work, ending with pros and cons e.g. “A second economic policy option to achieve the governments objective would be….. advantages of this policy option could be…… however drawbacks of this policy could be…….. (IF POSSIBLE USE ANOTHER DIAGRAM BUT NOT NECESSARY)

Para 4: explain your overall judgement, and explain what your judgement depends on e.g. In my overall judgement, the most effective policies to achieve the governments objective would be….. The strongest arguments in favour of choosing these policies are.… the strongest arguments against choosing these policies are…… however, the success of my chosen policies depends on…..
...
Commentary on analysis paragraph 1

This paragraph fully explains the benefits of dynamic efficiency for firms, a key reason for pursuing profit maximisation.

Dynamic efficiency works through two channels:

1) Investment of supernormal profit in R&D may lead to a more efficient production process, reducing production costs. 

2) Investment of supernormal profit in improving the product quality. This may increase demand for the firm’s product, increasing firm revenue. 

While the paragraph covers both channels, you could focus on one channel in your answer. 

For this question on business objectives, it’s important to link the effects of investing profits back to the benefits for the firm. In short, the ability to invest profit today allows the firm to make even more profit in the future.The diagram features the area representing supernormal profit. It is extended further with falling costs, illustrating a benefit of dynamic efficiency. 

The paragraph features the real world example of Apple, a company making high profits and churning out new products frequently. Apple is a useful example of dynamic efficiency in action. Think about the new features on the latest iPhone models, or consider another firm that you are familiar with. 
...
Commentary on evaluation paragraph 1

Profit allocation is a critical evaluation point for market structures essays.

The paragraph explains how profit may be allocated instead, with the example of Thames Water being accused of underinvestment in water infrastructure. 

This point is also clear as to the specific consequences: So what if profits are not invested? Then, profit maximisation may not generate the increases in quality or falling costs that we associate with dynamic efficiency. 
...
Cost-revenue diagram showing downward-sloping LRAC and LRMC due to economies of scale. Different objectives, such as sales max and profit max, are noted on this cost-revenue diagram.
Cost-revenue diagram showing downward-sloping LRAC due to economies of scale.
...
Commentary on analysis point 2

Economies of scale are an important reason why a firm may maximise sales. 

A good way to demonstrate economies of scale is the cost-revenue diagram with LRAC-LRMC being downward sloping, like with a natural monopoly. The revenue curves remain the same as usual, both downward sloping with MR being twice as steep as AR.

Note when mentioning economies of scale, it is usually advisable to refer to an example of economies of scale. In this case Amazon can spread many upfront costs, such as its distribution centres, over a larger amount of output. 

An excellent real world example for market structures essays are the “blitzscaling” companies. Spotify, Uber, many other tech startups and even Amazon (decades ago) engaged in this strategy. This involves making losses or low profits to expand the size of the company more quickly. Only later on, once the firm has achieved market power, would the firm increase prices and make higher profits.
...
Commentary on evaluation point 2

Note the point is linked to the question on business objectives, frequently mentioning sales maximisation. 

The point on diseconomies of scale is explained clearly, with a relevant real world example. 
Conclusion
...
The conclusion makes sure to answer the question and provide a justification for the answer.

There is also discussion of what the answer may “depend on”. Namely, the level of competition intervention.

This answer above would likely score full marks or close to this.

This answer is a relatively long answer, showing some of the possible points that could be discussed. A shorter answer would also be capable of scoring the highest mark.
...
ULEZ effect on top of an externality diagram. Taxing a good with a negative consumption externality.
...
Supply of tradable allowances under the ZEV mandate shifting left.
...
context and, where appropriate, good use of data to support the
response
...
Paper 2:
- Follows the same structure as Paper 1, with an extract, a 2 marker, 4 marker, 9 marker, 25 marker, 15 marker and 25 marker, but this time its for macroeconomics.
...
AD shift right plus multiplier - effect on macroeconomic objectives
AD shift right plus multiplier – effect on macroeconomic objectives
Evaluation paragraph 1
...
LRAS shift right: effect on macroeconomic objectives
LRAS shift right: effect on macroeconomic objectives
Evaluation point 2
...
Paper 3:
Paper 3 is a synoptic paper containing both macroeconomics and microeconomics, it starts off with 30 Multiple Choice Questions, 4 extracts with a Figure including Data. Theres a 15 marker and 25 marker which is the same as before, you might have to use different parts of the extract to help you formulate a response. The only new question is the 10 marker:

10 Marker Structure:
How to answer the 10 mark question
make 3 points in relation to the statement provided in the question
each point should contain
any argument that could answer the question
data to back up your point
show off your analysis/ chains of reasoning/ knowledge/ links
(quick) limitations of relying on that data
judgement - whether or not the statement is true
Model Answer:
...
“Most owner occupiers finance the purchase of their house by borrowing, using a mortgage” – Extract A line 3. In this case any deposits required at the start and the monthly payments and how this compares with disposable income in particular will influence affordability. Figure 3 shows the house price to earnings ratio for first time buyers in the UK. This is the group most likely to be impacted by affordability because they have to save for their deposit. In Q4 2007, the ratio stood at 5.4:1 but by Q4 2017, it had fallen to 5.2:1. On the face of it, this suggests that all else equal, affordability has actually improved. It seems unlikely though that all else is equal. The impact of the financial crisis is that lenders are more cautious making loans and that a bigger % of the value of a house is likely to be required as a deposit. This is likely to more than offset any small difference in the ratio. For house buyers more generally, “today the median price of a house is almost eight times median earnings, an all-time record” – Extract B lines 1 and 2. The extract is dated 2017 and if it is an all time record suggests less affordability generally than in 2007, although there is insufficient information presented in the extract to judge the extent.

Another factor influencing affordability will be the interest rate actually charged for mortgages. Figure 1 shows a significant fall from a little over 7½% standard variable rate in December 2007 to around 4¼% in December 2017. On the face of it, this suggests improved affordability but much will depend on what has happened to incomes over the same period. For first time buyers, figure 2 indicates that mortgage payments for first-time buyers in the UK as a percentage of mean take home pay has improved by 19 % points from 51% in Q4 2007 to 32% in 2017. This suggests improved affordability. It would be useful though to have some indicator of dispersion around the mean and also of other essential expenditures, such as energy. Also this information shows those who were able to make a purchase. Anyone outside of this group, for whom house purchase was unaffordable, would not be included.

Figure 4 shows information on average house prices and average weekly earnings. This may give a more complete picture of affordability. From end 2007 to end 2017, house prices on average rose by 19.85% and weekly earnings by 20.47%. This suggests that affordability may be broadly unchanged. However, the figures shown are nominal. Allowing for inflation around the target rate of 2% would suggest real earnings were very little changed, and possibly lower. This changes the conclusion on affordability and suggests on average it may well have worsened. It may well be too that disaggregated data would show significant differences on a regional basis for example that would be of concern to policy makers.

Only to a limited extent is it possible to conclude that houses in the UK were more affordable in 2017 than they were in 2007 and in fact the balance of the information provided suggests the opposite. Disaggregated data, were it available, may well suggest this is especially so for certain groups.

Mark Scheme:
A good response that:
• is well organised and includes at least three relevant,
...
• includes a supported final judgement concerning the extent to
which the data support the view.

An answer that got 25/25:

Evaluate policies which a UK government could use to control the activities of oligopolists (25) (2012)

An oligopolistic market is one in which a small number of large firms have a strong/dominant market position, with a high concentration ratio and barriers to entry. For example, supermarkets in the UK have a concentration ratio of approximately 5:80. Oligopolists, in line with the traditional theory of the firm, produce at profit-maximising output where HR = MC, earning supernormal profits of (R1-C1) × Q1. The government tends to control the actions of an oligopoly by limiting behaviour considered anticompetitive or harmful to consumers' interests. Such policies are implemented by the Competition Commission and the Office of the Trading. [Used an Oligopoly Diagram, with AC, MC, MR and AR and labelled accurately, highlighting supernormal profits and with cost (£) in the y-axis and output (units) in the x-axis] Gaining a dominant market position is one way in which oligopolists may gain the power to exploit consumers in a way that would be against the consumer's interest. Those with a dominant market position may gain the power of price discrimination, or simply the power to increase prices and reduce output to maximise profit. One way to do this is to ban mergers that give a new firm market share of over 25%. For example, in 2009, the Competition Commission banned Stagecoach's attempted takeover of Presbon Bus Limited due to concerns about fares and service quality on selected routes. However, the control of mergers gives the CC only limited power, as it only prevents firms from growing organically. It has no power to prevent organic growth, which may lead to a firm expanding to 25% market share (e.g., Tesco, approx. 33%) or to 80% (e.g., Windows, approx.).

Another way the UK government can control oligopolists' activities is by outlawing much of the anti-competitive behaviour characteristic of oligopolies. This is the outlawing of collusion (formal and informal), which can adversely affect consumers' interests. The CC outlaws price fixing, market sharing, supply restricting and price leadership agreements in oligopoly. Offenders found and prosecuted can be fined up to 10% of their annual revenue. However, there are many criticisms of the policy. Firstly, anti-competitive agreements are made in secret, and thus very few cases are ever discovered and prosecuted. Furthermore, a 10% revenue fine may not be sufficient to outweigh the potential benefits of collusion. For example, despite legislation, British Airways and Virgin Atlantic were prosecuted for colluding on fuel surcharges on long-haul flights. The Office of Fair Trading fined BA £121.5m (later reduced to £58.5m) for the price-fixing agreement between 2004 and 2006, while Virgin Atlantic escaped a fine by reporting the activity. The fact that collusion still occurred suggests either that the firms did not believe they would be caught or that the potential profits were worth the risk of the fine. Perhaps if company directors were held criminally responsible for their actions, it would be a more effective deterrent.

Oligopolistic market structures are common in previously nationalised industries, such as electricity provision. To limit exploitative behaviour in strategic industries, independent government regulators such as OFGEM have been established to regulate them. They can impose direct price controls, such as RPI-X, on company prices, limiting price rises to consumers and also incentivising firms to invest in innovation and increase dynamic efficiency to cut costs and increase profits. However, regulatory bodies are very expensive to run and are funded by taxpayers. If the regulator's spending exceeds the savings for consumers from its presence, this policy is criticised. Furthermore, there is the problem of regulatory capture: large oligopolistic firms have the power to influence regulators through bribes or other forms of influence. Their interests align with the firms', and consumers lose out.
